...
class CurrentOrderSchema extends Schema {
  up() {
    this.create('current_orders', (table) => {
      ...
      table.text('product_photo').comment('This is the photo of product order').nullable()
      table.text('product_photo_file_ids').comment('This is the file id of products photo').nullable()
