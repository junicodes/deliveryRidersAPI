...
class CurrentOrderSchema extends Schema {
  up() {
    this.create('current_orders', (table) => {
      ...
      table.string('product_photo').json().comment('This is the photo of product order')
      ...
      table.string('status').comment('This is the estimated price for this order').nullable()
